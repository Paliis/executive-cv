...
<body>
  ...
  <p class="meta"><a href="https://parshentsev-cv.vercel.app/?v=2"><b>Веб-візитка</b></a></p>
  ...
  <p class="company">LOKO (Fozzy Group)<span class="dates"> | Квітень 2023 — Поточний час</span></p>
  <p class="context">Контекст: Q-commerce екосистема у складі найбільшого продуктового рітейлера України.</p>
  <p class="role">Заступник керівника LOKO з питань стратегічних проектів та партнерств<span class="dates"> | Квітень 2023 — Поточний час</span></p>
  <ul>
